    ...
    <div class="wrapper">
        <div class="form">
            ...
            <div class="container">
                ...
                <button type="button" class="btn" name="register" onclick="window.location.href='../Activity4/index.php'">Cancel</button>
                </center>          
...
<?php
    ...
    if (isset($_POST['username'])){
        ...
        if($newpassword !== $confirmpassword){
            ...
            echo "<h4>Password Changed. Go to <a href='../Activity4/index.php'> Login <a></h4>";
