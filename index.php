        ...
        <div class="form">
            ...
            <div class="container">
                ...
                <center><button type="submit" class="btn" method="post" name="login">Login</button>
                    <button type="button" class="btn" name="register" onclick="window.location.href='../Activity4/signup.php'">Register</button>
                </center>
                <!--<button type="button"  class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" onclick="openWin()">Login</button>-->
                <h1><a href="../Activity4/forgot.php"> FORGOT PASSWORD </a></h1>               
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){ 
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $link = "<script>window.open('http://localhost/Activity4/authenticator.php')</script>"; 
                            echo $link; 
...
<?php
    ...
    if (isset($_POST['username'])){
        ...
        if($rows==1){
            ...
            header("location: ../Activity4/authenticator.php");
